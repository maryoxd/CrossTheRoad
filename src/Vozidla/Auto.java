...
/**
 * Trieda Auto slúži na vytváranie a vykreslovanie objektu auta v triede HraciPanel.
 */
public class Auto {
    private int x;
    private int y;
    ...
    private int sirka;
    /**
     * Auto si pýta hodnoty X a Y, pomocou ktorých objekt vykreslujeme na daných súradniciach.
    ...
    public void draw(Graphics2D gtd) {
        Image obrazok1 = Toolkit.getDefaultToolkit().getImage("pics/autoDoprava.png");
    ...
    public void drawDolava(Graphics2D gtd) {
        Image obrazok2 = Toolkit.getDefaultToolkit().getImage("pics/AutoDolava.png");
